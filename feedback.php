      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <div class="mb-0 site-logo"><a href="adminpage.php" class="mb-0" color="text-black">Product Expiry Admin Page<span class="text-primary">.</span> </a></div>
          </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-lg-7 mx-auto text-center">
            ...
            <h2 class="heading"><strong class="text-primary">Commented From</strong> Individual Person</h2>
          </div>
        </div>
...
<div class='row'>
 <div class='col-6 col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-4'>
              ...
              <tr><td><h5>".$row['name']."</h5></td>
              <td><h6>".$row['email']."</h6></td>
              <td><p>".$row['message']."</p></td></tr>
