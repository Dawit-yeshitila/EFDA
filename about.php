  ...
  <div class="site-wrap">
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <p><img src="images/christine-sandu-jwWtZrm67VI-unsplash.jpg" alt="Image" class="img-fluid"></p>
          </div>
          <div class="col-lg-5 ml-auto">
            <span class="subheading">About Us</span>
            <h2 class="heading"><strong class="text-primary"> Our Objectives</strong></h2>
            <p>To protect the health of consumers by ensuring:-
                <ul>
            <li>Food safety and quality </li>
            <li>Safety, efficacy, quality and proper use of medicines</li>
            <li>Safety, quality and performance of medical device</li>
                       </ul></p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-5 mr-auto">
            ...
            <p>To promote and protect the public health by ensuring safety, efficacy and quality of health and health-related products and services through product quality assessment and registration; licensing and inspection of health professionals, health institutions, pharmaceutical and food establishments, and provision of up-to-date regulatory information while promoting proper use of health and health-related products and services including proper use of medicines.</p>
            
          </div>
          <div class="col-lg-6">
            <figure class="video-image">
              <a href="" data-fancybox class="btn-play"><span class="icon-play"></span></a>
              <img src="images/c67cc114fc289a3eacc442da873053b2.jpg" alt="Image" class="img-fluid">
            </figure>
          </div>
        </div>
      </div>
    ...
    <div class="site-section pt-0">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6">
            <p><img src="images/nastya-dulhiier-ALP8jXJ_bp8-unsplash.jpg" alt="Image" class="img-fluid"></p>
          </div>
          <div class="col-lg-5 ml-auto">
            <span class="subheading">About </span>
            <h2 class="heading"><strong class="text-primary">The Authority</strong></h2>
            <p>The Ethiopian Food and Drug Administration (EFDA) is mandated, in the proclamation 661/2009, to ensure the safety, quality and efficacy of medicines. To achieve this, the authority has been working on different regulatory activities. The medicine market authorization system is one of the top priority areas that have been implemented. In addition to the dedicated assessors, the authority uses a national drug advisory committee for the assessment and registration of medicines. This has evolved over the years to improve the medicine dossier evaluation system.</p>
            <p><a href="contact.php" class="btn btn-primary">Contact Us</a></p>
          </div>
        </div>
      </div>
