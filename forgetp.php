...
$sql = "UPDATE orguser set password ='$pass' where email='$email')";

$query =mysqli_query($conn, $sql);
if ($query) {

  echo "<alert>You Have successfully update your password !</alert>";
  
} 
else {
  echo "<alert>You Haven't update yet  !</alert>";
}
}
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="site-section pb-0">
      <div class="container">
        <div class="col-lg-7 mx-auto text-center mb-5">
            <span class="subheading">Please, Change  </span>
            <h2 class="heading"><strong class="text-primary">Only If You</strong> have Forgotten Password !</h2>
          </div>
        <div class="row mb-5">
          <div class="col-md-7 pr-md-7 mb-5">
     <form action="forgetp.php" method="post" name="form1" onSubmit="return validateForm(); " >
  ...
  <div></div>
  <button type="submit" name="forget" class="btn btn-primary">Enter</button>
</form>
 </div>
   </div> <!-- .row -->
