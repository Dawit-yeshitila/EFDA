      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 align-self-center text-center mx-auto">
            <h1 class="heading mb-5"> Give Reply messages arrive from client !</h1>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-7 pr-md-7 mb-5">
            <form class="form-horizontal" role="form" name="form1" onSubmit="return validateForm();" enctype="multipart/form-data" action="replym.php" method="post">
              <div class="form-row">
              <div class="form-group col-md-6">

              <div class="form-group">
                <label for="message">Reply</label>
                <textarea name="message" id="message"  form ="reply"cols="30" rows="10" class="form-control"  required="required" ></textarea>
              </div>
             <!--<div class="form-group">
                <button type="submit" name="reply" class="btn btn-primary py-3 px-5" value="Send Message">Reply</button>
              </div>-->
            </form>
          </div>
     <?php      
...
echo "
        <div class='col-6 col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-4'>
         ...
         <form method='post' action='replym.php'  >
    <input type='hidden' value=".$row['id']." name='id'>
    <td><button name='del' type='submit' value='Delete' class='btn btn-warning'  onclick='return Delete()'>DELETE</button></td>
    <td><button name='update' type='submit' value='Update' class='btn btn-warning'  onclick='return reply()'>Reply</button></td>
    </form></tr>
            </div>
          </div>
        ";
...
<footer class="footer-section">
 ...
 function Update() {
  ...
  {
  alert(" Message Cannot Contain other Values");
